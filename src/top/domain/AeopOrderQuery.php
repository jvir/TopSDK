...
class AeopOrderQuery
{
	...
	/** 
	 * 订单创建时间结束值，格式: yyyy-mm-dd hh:mm:ss
	 **/
	public $create_date_end;
	
	/** 
	 * 订单创建时间起始值 格式: yyyy-mm-dd hh:mm:ss
	 **/
	...
	/** 
	 * 订单修改时间结束值，格式: yyyy-mm-dd hh:mm:ss
	 **/
	public $modified_date_end;
	
	/** 
	 * 订单修改时间起始值 格式: yyyy-mm-dd hh:mm:ss 需要加上createdate控制查询范围。可查询时间范围；默认180天，查询已结束订单为30天。
	 **/
